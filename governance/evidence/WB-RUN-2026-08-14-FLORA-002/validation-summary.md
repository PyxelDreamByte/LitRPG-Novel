---
run_id: "run://develop-worldbuilding/WB-RUN-2026-08-14-FLORA-002"
validated_on: "2026-08-14"
status: PASS
---

# Validation Summary — WLD-FLORA-002
...
- `python tools/validate_governance.py --verify-current-accepted governance/evidence/WB-RUN-2026-08-14-FLORA-002/WB-RUN-2026-08-14-FLORA-002.workflow-evidence.json`
  — passed with 22 repository records, 5 valid fixtures, 5 rejected fixtures,
...
The final post-evidence repository run verified 82 non-CAL0 JSON files, all 22
