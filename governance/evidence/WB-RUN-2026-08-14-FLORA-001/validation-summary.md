---
run_id: "run://develop-worldbuilding/WB-RUN-2026-08-14-FLORA-001"
validated_on: "2026-08-14"
status: PASS
---

# Validation Summary — WLD-FLORA-001
...
- `python tools/validate_governance.py --verify-current-accepted governance/evidence/WB-RUN-2026-08-14-FLORA-001/WB-RUN-2026-08-14-FLORA-001.workflow-evidence.json`
  — passed with 19 repository records, 5 valid fixtures, 5 rejected fixtures,
  and exact current-byte verification of the new accepted-outcome bundle.
...
The final post-evidence repository run verified 79 non-CAL0 JSON files, all 19
